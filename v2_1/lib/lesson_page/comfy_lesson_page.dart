                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => chatPage(
                                      questions: {
                                        'comment': [
                                          'Thank you for reading "${widget.lesson.title}"',
...
Future<void> send_lesson_comment(BuildContext context, String user,
    String lessonTitle, String comment) async {
  await sendEmailGeneral('$user has commented on $lessonTitle: $comment');
