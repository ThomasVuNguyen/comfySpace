...
Future<String?> getStaticIp(String hostname) async {
  ...
  final List<String>? currentLocalhostList =
      prefs.getStringList('localhostList');
  ...
  if (kIsWeb == false) {
    try {
      ...
      final clientResponse =
          await sshClient.run('hostname -I | awk \'{print \$1}\'');
      ...
      print('error acquiring static ip');
    }
  } else {
