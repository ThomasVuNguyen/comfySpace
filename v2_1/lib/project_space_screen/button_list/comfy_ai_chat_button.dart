      ...
      speech.listen(onResult: (result) {
        ...
        if (Platform.isAndroid == true && speech.lastStatus == 'notListening') {
          ...
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text(result.recognizedWords)));
            ...
            child: Stack(
              ...
              children: [
                ...
                Container(
                    child: Padding(
                  padding:
                      const EdgeInsets.only(left: 25, right: 25, bottom: 45),
                  child: Image.asset(
                    'assets/gemini/gemini-logo.webp',
                  ),
                )),
                Padding(
