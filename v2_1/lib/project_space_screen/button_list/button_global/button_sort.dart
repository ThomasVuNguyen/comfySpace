...
import 'package:v2_1/project_space_screen/button_list/comfy_joystick_button.dart';
          ...
          switch (widget.button.type) {
            case 'tap':
              return comfy_tap_button(
                ...
                staticIP: widget.staticIP,
                port: widget.port,
                username: widget.username,
                password: widget.password,
              );
            case 'toggle':
              return comfy_toggle_button(
                button: widget.button,
                hostname: widget.hostname,
                staticIP: widget.staticIP,
                port: widget.port,
                      ...
                      child: IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushAndRemoveUntil(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ButtonEditAndDeletePage(
