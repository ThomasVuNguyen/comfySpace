...
class ButtonEditAndDeletePage extends StatefulWidget {
  ...
  @override
  State<ButtonEditAndDeletePage> createState() =>
      _ButtonEditAndDeletePageState();
}
  ...
  Future<void> navigate() async {
    if (_confirmationPage == false) {
      if (_showSelectionScreen == true) {
        ...
        if (buttonThemeController.text.isEmpty ||
          ...
          ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Theme & Color cannot be empty')));
        } else {
          setState(() {
            _showSelectionScreen = false;
            _pickButtonTypeAndName = false;
      ...
      if (buttonTypeController.text.toLowerCase() == 'tap') {
        buttonFunction = {
          'tap': (tapCommandTextController.text.isEmpty == true)
              ? ''
              : tapCommandTextController.text
        };
      } else if (buttonTypeController.text.toLowerCase() == 'toggle') {
        buttonFunction = {
          'on': (toggleOnCommandTextController.text.isEmpty == true)
              ? ''
              : toggleOnCommandTextController.text,
          'off': (toggleOffCommandTextController.text.isEmpty == true)
              ? ''
              : toggleOffCommandTextController.text,
        };
      } else if (buttonTypeController.text.toLowerCase() == 'swipe') {
        buttonFunction = {
          'up': (swipeUpCommandTextController.text.isEmpty == true)
              ? ''
              : swipeUpCommandTextController.text,
          'down': (swipeDownCommandTextController.text.isEmpty == true)
              ? ''
              : swipeDownCommandTextController.text,
          'tap': (swipeTapCommandTextController.text.isEmpty == true)
              ? ''
              : swipeTapCommandTextController.text,
          'left': (swipeLeftCommandTextController.text.isEmpty == true)
              ? ''
              : swipeLeftCommandTextController.text,
          'right': (swipeRightCommandTextController.text.isEmpty == true)
              ? ''
              : swipeRightCommandTextController.text,
          'api': (AIButtonTextController.text.isEmpty == true)
              ? ''
              : AIButtonTextController.text
        };
      }
      await edit_button(
          context,
        ...
        child: Column(
          ...
          children: [
            ...
            Builder(builder: (context) {
              String btnName = (widget.button.name == null)
                  ? 'button name'
                  : widget.button.name!;
              String type =
                  (widget.button.type == null) ? 'tap' : widget.button.type!;
              int order = 1;
              ...
              child: Row(
                ...
                children: [
                  clickable_text(
                    ...
                    onTap: () async {
                      await delete_button(
                              context, widget.projectName, widget.button.name!)
            ...
            Visibility(
              ...
              child: //Text('Welcome to buttons!')
                ...
                isRepeatingAnimation: false,
                animatedTexts: [
                  TypewriterAnimatedText('Pick a new name?',
                      textAlign: TextAlign.center,
                      textStyle: Theme.of(context).textTheme.titleMedium,
                      speed: const Duration(milliseconds: 100)),
                ],
            ...
            Visibility(
              ...
              child: ButtonCommandCreatePage(
                ...
                buttonFunction: {
                  'on': (widget.button.function?['on'] == null)
                      ? ''
                      : widget.button.function!['on']!,
                  'off': (widget.button.function?['off'] == null)
                      ? ''
                      : widget.button.function!['off']!,
                  'tap': (widget.button.function?['tap'] == null)
                      ? ''
                      : widget.button.function!['tap']!,
                  'up': (widget.button.function?['up'] == null)
                      ? ''
                      : widget.button.function!['up']!,
                  'down': (widget.button.function?['down'] == null)
                      ? ''
                      : widget.button.function!['down']!,
                  'left': (widget.button.function?['left'] == null)
                      ? ''
                      : widget.button.function!['left']!,
                  'right': (widget.button.function?['right'] == null)
                      ? ''
                      : widget.button.function!['right']!,
                ...
                aiAPIButtonTextController: AIButtonTextController,
              ),
            ),
            ...
            Visibility(
              ...
              child: Padding(
                ...
                child: AnimatedTextKit(
                  isRepeatingAnimation: false,
                  animatedTexts: [
                    TypewriterAnimatedText('Here is your new button!',
                        textAlign: TextAlign.center,
                        textStyle: Theme.of(context).textTheme.titleMedium,
                        speed: const Duration(milliseconds: 100)),
                  ],
