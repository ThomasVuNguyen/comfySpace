...
class buttonSelectionTitle extends StatelessWidget {
  const buttonSelectionTitle({super.key, required this.titleText, this.url = ''});
  final String titleText; final String url;

  void showInformation(String url, BuildContext context, ){
