...
class _ComfyFullGestureButtonState extends State<ComfyFullGestureButton> {
  ...
  int index = 0;
  List<Widget> buttonIcon = [const Icon(Icons.pause_circle_filled, size: 60, ), const Icon(Icons.arrow_left, size: 60, color: Color(0xffFE9D35),), const Icon(Icons.arrow_right, size: 60, color: Color(0xffFE9D35),), const Icon(Icons.arrow_upward, size: 60, color: Color(0xffFE9D35),),  const Icon(Icons.arrow_downward, size: 60, color: Color(0xffFE9D35),)];
  List<Color> buttonColor = [Color(0xffA0ABC0),Color(0xffFED7AD),Color(0xffFED7AD),Color(0xffFED7AD),Color(0xffFED7AD),Color(0xffFED7AD)];
  @override
  void initState(){
    super.initState();
    initClient();
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text('${widget.name} ',style: GoogleFonts.poppins( fontWeight: FontWeight.w400, fontSize: 18,  color: Colors.black)),
                    direction == "middle"? const Icon(Icons.gesture, color: Colors.black,) : const SizedBox(height: 0, width: 0,),
                  ],
                ),
              ),
            ],
